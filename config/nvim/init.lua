...
vim.cmd([[highlight Search guifg=#c0856b guibg=#661d05]]) -- [INFO]: fg=chocolate_cream, bg=chocolate_rose
...
function map_keys (keymaps, cmd) 
  -- [INFO]: keymaps (modes='n,g,v,i,t':'n', key, action, opt(silent)=true/false:true)
